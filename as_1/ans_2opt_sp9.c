/*
	Naive search space division/Proper/Distance cache/Partial distance compare
*/
#include <stdio.h>
#include <pthread.h>
#include <stdlib.h>
...
int main(int argc, char const *argv[])
{
	...
	printf("Naive search space division/Proper/Distance cache/Partial distance compare:\n");
	parallel_2opt();
